    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[700px]">
        <DialogHeader>
          ...
          <DialogDescription>
            View detailed information about this portfolio
          </DialogDescription>
        </DialogHeader>
        ...
        <Tabs defaultValue="basic" className="mt-4">
          ...
          <TabsContent value="financial" className="space-y-4 py-4">
            <div className="grid grid-cols-3 items-center gap-4">
              ...
              <span className="col-span-2">
                {formatCurrency(portfolio.cashRemaining)}
              </span>
            </div>
            <div className="grid grid-cols-3 items-center gap-4">
              <span className="font-medium">Subscription Fee:</span>
              <span className="col-span-2">
                {formatCurrency(portfolio.subscriptionFee)}
              </span>
            </div>
            <div className="grid grid-cols-3 items-center gap-4">
            ...
            {!portfolio.holdings || portfolio.holdings.length === 0 ? (
              ...
              <div className="space-y-3">
                ...
                <div className="mt-4 flex justify-between rounded-md bg-muted p-2 text-sm">
                  ...
                  <span>
                    {portfolio.holdings.reduce((sum, h) => sum + h.weight, 0)}%
                  </span>
                </div>
              </div>
            )}
